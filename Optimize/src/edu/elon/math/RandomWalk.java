 ...
 *
 * Copyright (c) 2014 David J. Powell, Spencer Newsom, Elon University
...
/**
 * Randomly try different points and keep the best seen. The default number of
 * evaluations is 10000
 * 
 * @author dpowell2
 * @version 1.0
 * 
 */
public class RandomWalk implements Technique {
	...
	/**
	 * Default constructor sets limits on range of random value selection to
	 * plus and minus 100. Sets maximum number of function evaluations to 10000
	 * 
	 */
	public RandomWalk() {
	 ...
	 * 
	 * @param start
	 *            ArrayList<Double> representing an input point.
	 ...
	 */
	@Override
	public double evalute(Function f) throws RemoteException {
		Double currentValue;
	 ...
	 * 
	 * @param largestValue
	 *            double representing the largest value that an input may have.
	 */
	 ...
	 * parameter.
	 * 
	 * @param maxNumberEvaluations
	 *            int representing max number of function evaluations.
	 */
	 ...
	 * 
	 * @param smallestValue
	 *            int double representing the smallest value that an input may
	 *            have.
	 */
